...
import 'package:recepie/views/recipe_view.dart';
                        ...
                        InkWell(
                            onTap: () async {
                              if (textEditingController.text.isNotEmpty) {
                                ...
                                recipies = [];
                                String url =
                                    ("https://api.edamam.com/search?q=${textEditingController.text}&app_id=6b393edf&app_key=3080066b218ac42fbff6c49dfdeef470");
                                Uri u = Uri.parse(url);
                                ...
                                jsonData["hits"].forEach((element) {
                                  ...
                                  RecipeModel recipeModel = new RecipeModel(label: '', source: '', image: '', url: '');
                                  recipeModel =
